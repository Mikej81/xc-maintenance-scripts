...
API_URL="https://${TENANT_NAME}.console.ves.volterra.io/api/web/namespaces/system/api_credentials"
REVOKE_URL="https://${TENANT_NAME}.console.ves.volterra.io/api/web/namespaces/system/revoke/api_credentials"
